...
#define _KPPLUS       ( row9 | col0 )     //  _KPTIMES
#define _KPMINUS      ( row9 | col1 )     //  _KPPLUS
#define _KPTIMES      ( row9 | col2 )     //  _KPSLASH
#define _KPSLASH      ( row9 | col3 )     //  _KP0
#define _NONE         ( row9 | col4 )     //  _KP1
#define _NONE         ( row9 | col5 )     //  _KP2
#define _NONE         ( row9 | col6 )     //  _KP3
#define _NONE         ( row9 | col7 )     //  _KP4

#define _NONE         ( rowA | col0 )     //  _KP5
#define _NONE         ( rowA | col1 )     //  _KP6
#define _NONE         ( rowA | col2 )     //  _KP7
#define _NONE         ( rowA | col3 )     //  _KP8
#define _NONE         ( rowA | col4 )     //  _KP9
#define _NONE         ( rowA | col5 )     //  _KPMINUS
#define _NONE         ( rowA | col6 )     //  _KPCOMMA
#define _NONE         ( rowA | col7 )     //  _KPDOT
